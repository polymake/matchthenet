...
// COMMON_CODE_BLOCK_END
   ...
   var subtrees = [[120,121],
      ...
      [76,77],
      [74,75,96,97,98,99,112,113,114,115,120,121],
      [72,73,94,95],
      [70,71,92,93,110,111],
      [68,69,90,91,108,109],
      [66,67],
      ...
      [58,59,82,83,104,105],
      [56,57],
      [54,55,78,79,80,81,100,101,102,103,116,117],
      [52,53,76,77],
      [50,51,74,75,96,97,98,99,112,113,114,115,120,121],
      [48,49,72,73,94,95],
      [46,47,68,69,70,71,90,91,92,93,108,109,110,111],
      [44,45,66,67],
      [42,43,64,65,88,89],
      [40,41],
      ...
      [34,35,56,57],
      [32,33,54,55,78,79,80,81,100,101,102,103,116,117],
      [30,31,52,53,76,77],
      [28,29,50,51,74,75,96,97,98,99,112,113,114,115,120,121],
      [26,27,48,49,72,73,94,95],
      [24,25,46,47,68,69,70,71,90,91,92,93,108,109,110,111],
      [22,23,42,43,44,45,64,65,66,67,88,89],
      [20,21,40,41],
      [18,19,36,37,38,39,58,59,60,61,62,63,82,83,84,85,86,87,104,105,106,107,118,119],
      [16,17,34,35,56,57],
      [14,15,30,31,32,33,52,53,54,55,76,77,78,79,80,81,100,101,102,103,116,117],
      [12,13,28,29,50,51,74,75,96,97,98,99,112,113,114,115,120,121],
      [10,11,26,27,48,49,72,73,94,95],
      [8,9,22,23,24,25,42,43,44,45,46,47,64,65,66,67,68,69,70,71,88,89,90,91,92,93,108,109,110,111],
      [6,7,18,19,20,21,36,37,38,39,40,41,58,59,60,61,62,63,82,83,84,85,86,87,104,105,106,107,118,119],
   ...
   allpoints.push(new PMPoint(1.76486, -0.949036, 0));
   allpoints.push(new PMPoint(-0.211684, -1.44691, 0));
   allpoints.push(new PMPoint(0.148614, -1.44691, 0));
   allpoints.push(new PMPoint(-0.7099, -1.26952, 0));
   allpoints.push(new PMPoint(-0.379108, -1.41232, 0));
   allpoints.push(new PMPoint(0.511408, -1.45529, 0));
   allpoints.push(new PMPoint(0.842201, -1.59808, 0));
   ...
   allpoints.push(new PMPoint(1.33426, -1.50289, 0));
   allpoints.push(new PMPoint(1.67826, -1.39576, 0));
   allpoints.push(new PMPoint(-0.182407, -2.00076, 0));
   allpoints.push(new PMPoint(0.319254, -1.76424, 0));
   allpoints.push(new PMPoint(-1.24249, -1.06913, 0));
   allpoints.push(new PMPoint(-1.01143, -1.46674, 0));
   allpoints.push(new PMPoint(-0.992333, -1.49323, 0));
   allpoints.push(new PMPoint(-0.625495, -1.90921, 0));
   ...
   allpoints.push(new PMPoint(0.658949, 2.35962, 0));
   allpoints.push(new PMPoint(0.348304, 2.54215, 0));
   allpoints.push(new PMPoint(1.95731, -1.62367, 0));
   allpoints.push(new PMPoint(2.22901, -1.25263, 0));
   allpoints.push(new PMPoint(1.52689, -2.02298, 0));
   allpoints.push(new PMPoint(1.93553, -1.648, 0));
   allpoints.push(new PMPoint(-1.70665, -1.37273, 0));
   allpoints.push(new PMPoint(-1.33206, -1.63108, 0));
   allpoints.push(new PMPoint(-1.24961, -1.74547, 0));
   allpoints.push(new PMPoint(-1.1493, -2.09152, 0));
   ...
   allpoints.push(new PMPoint(-0.901621, 2.37591, 0));
   allpoints.push(new PMPoint(-1.19129, 2.16166, 0));
   allpoints.push(new PMPoint(-1.47002, 1.973, 0));
   allpoints.push(new PMPoint(-1.82553, 1.91446, 0));
   allpoints.push(new PMPoint(2.25884, -1.8209, 0));
   allpoints.push(new PMPoint(2.65857, -1.60347, 0));
   allpoints.push(new PMPoint(2.02855, -2.25951, 0));
   allpoints.push(new PMPoint(2.16478, -1.92596, 0));
   allpoints.push(new PMPoint(-1.82553, -1.91446, 0));
   allpoints.push(new PMPoint(-1.37176, -1.98919, 0));
   allpoints.push(new PMPoint(2.71968, 2.15472, 0));
   allpoints.push(new PMPoint(2.35998, 2.17546, 0));
   allpoints.push(new PMPoint(2.26056, -2.18119, 0));
   allpoints.push(new PMPoint(2.71968, -2.15472, 0));
   ...
   faces.faces.push(new THREE.Face3(32, 78, 79, undefined, undefined, 33));
   faces.faces.push(new THREE.Face3(32, 79, 54, undefined, undefined, 33));

   faces.faces.push(new THREE.Face3(62, 38, 86, undefined, undefined, 34));
   faces.faces.push(new THREE.Face3(62, 86, 87, undefined, undefined, 34));

   faces.faces.push(new THREE.Face3(61, 60, 84, undefined, undefined, 35));
   faces.faces.push(new THREE.Face3(61, 84, 85, undefined, undefined, 35));

   faces.faces.push(new THREE.Face3(47, 69, 90, undefined, undefined, 36));
   faces.faces.push(new THREE.Face3(47, 90, 91, undefined, undefined, 36));

   faces.faces.push(new THREE.Face3(65, 64, 88, undefined, undefined, 37));
   faces.faces.push(new THREE.Face3(65, 88, 89, undefined, undefined, 37));

   faces.faces.push(new THREE.Face3(51, 75, 96, undefined, undefined, 38));
   faces.faces.push(new THREE.Face3(51, 96, 97, undefined, undefined, 38));

   faces.faces.push(new THREE.Face3(73, 72, 94, undefined, undefined, 39));
   faces.faces.push(new THREE.Face3(73, 94, 95, undefined, undefined, 39));

   faces.faces.push(new THREE.Face3(71, 70, 92, undefined, undefined, 40));
   faces.faces.push(new THREE.Face3(71, 92, 93, undefined, undefined, 40));

   faces.faces.push(new THREE.Face3(82, 104, 105, undefined, undefined, 41));
   faces.faces.push(new THREE.Face3(82, 105, 83, undefined, undefined, 41));

   faces.faces.push(new THREE.Face3(69, 108, 109, undefined, undefined, 42));
   faces.faces.push(new THREE.Face3(69, 109, 90, undefined, undefined, 42));

   faces.faces.push(new THREE.Face3(78, 100, 101, undefined, undefined, 43));
   faces.faces.push(new THREE.Face3(78, 101, 79, undefined, undefined, 43));

   faces.faces.push(new THREE.Face3(87, 86, 106, undefined, undefined, 44));
   faces.faces.push(new THREE.Face3(87, 106, 107, undefined, undefined, 44));

   faces.faces.push(new THREE.Face3(93, 92, 110, undefined, undefined, 45));
   faces.faces.push(new THREE.Face3(93, 110, 111, undefined, undefined, 45));

   faces.faces.push(new THREE.Face3(97, 96, 112, undefined, undefined, 46));
   faces.faces.push(new THREE.Face3(97, 112, 113, undefined, undefined, 46));

   faces.faces.push(new THREE.Face3(100, 116, 117, undefined, undefined, 47));
   faces.faces.push(new THREE.Face3(100, 117, 101, undefined, undefined, 47));

   faces.faces.push(new THREE.Face3(107, 106, 118, undefined, undefined, 48));
   faces.faces.push(new THREE.Face3(107, 118, 119, undefined, undefined, 48));

   faces.faces.push(new THREE.Face3(112, 120, 121, undefined, undefined, 49));
   faces.faces.push(new THREE.Face3(112, 121, 113, undefined, undefined, 49));
   ...
   faces.faces.push(new THREE.Face3(54, 80, 81, undefined, undefined, 55));
   faces.faces.push(new THREE.Face3(54, 81, 55, undefined, undefined, 55));

   faces.faces.push(new THREE.Face3(53, 52, 76, undefined, undefined, 56));
   faces.faces.push(new THREE.Face3(53, 76, 77, undefined, undefined, 56));

   faces.faces.push(new THREE.Face3(80, 102, 103, undefined, undefined, 57));
   faces.faces.push(new THREE.Face3(80, 103, 81, undefined, undefined, 57));

   faces.faces.push(new THREE.Face3(75, 74, 98, undefined, undefined, 58));
   faces.faces.push(new THREE.Face3(75, 98, 99, undefined, undefined, 58));

   faces.faces.push(new THREE.Face3(99, 98, 114, undefined, undefined, 59));
   faces.faces.push(new THREE.Face3(99, 114, 115, undefined, undefined, 59));
