...
obj0.userData.edgeindices = [1, 5, 2, 5, 3, 5, 4, 5, 2, 7, 3, 7, 6, 7, 0, 8, 2, 8, 4, 8, 6, 8, 7, 9, 1, 10, 3, 10, 9, 10, 10, 11, 0, 12, 1, 12, 4, 12, 8, 12, 11, 12, 0, 13, 6, 13, 8, 13, 9, 13, 11, 13, 12, 13];
   <!-- Edge style -->
obj0.userData.edgematerial = new THREE.LineBasicMaterial( { color: 0x000000, linewidth: polytopeLineWidth, transparent: false } );
obj0.userData.facets = [[11, 13, 12], [11, 10, 9, 13], [11, 12, 1, 10], [12, 13, 0], [12, 0, 8], [0, 13, 8], [13, 9, 7, 6], [8, 13, 6], [8, 6, 7, 2], [5, 4, 8, 2], [1, 12, 4, 5], [12, 8, 4], [3, 5, 2, 7], [10, 3, 7, 9], [10, 1, 5, 3]];
   <!-- Facet style -->
