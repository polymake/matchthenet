...
obj0.name = "johnson_08_dual";
obj0.userData.explodable = 1;
obj0.userData.points = [];
obj0.userData.points.push(new PMPoint(1.13713, 0, 0));
obj0.userData.points.push(new PMPoint(0, 1.13713, 0));
obj0.userData.points.push(new PMPoint(0, 0.749382, -0.529893));
obj0.userData.points.push(new PMPoint(0, -1.13713, 0));
obj0.userData.points.push(new PMPoint(-1.13713, 0, 0));
obj0.userData.points.push(new PMPoint(0, 0, 0.896619));
obj0.userData.points.push(new PMPoint(0.749382, 0, -0.529893));
obj0.userData.points.push(new PMPoint(0, -0.749382, -0.529893));
obj0.userData.points.push(new PMPoint(-0.749382, 0, -0.529893));
...
obj0.userData.edgeindices = [0, 1, 1, 2, 0, 3, 1, 4, 3, 4, 0, 5, 1, 5, 3, 5, 4, 5, 0, 6, 2, 6, 3, 7, 6, 7, 2, 8, 4, 8, 7, 8];
   <!-- Edge style -->
...
obj0.userData.facets = [[2, 1, 0, 6], [2, 8, 4, 1], [6, 0, 3, 7], [7, 3, 4, 8], [0, 1, 5], [5, 1, 4], [0, 5, 3], [5, 4, 3], [2, 6, 7, 8]];
   <!-- Facet style -->
